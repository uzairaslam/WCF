...
namespace CompanyService
{
  ...
  public class CompanyService : ICompanyPublicService, ICompanyConfidentialService
  {
    ...
    {
      return "This is confidential service and only available over TCP behind the company firewall";
    }

    public string GetPublicInformation()
    {
      return "This is public information available over HTTP to all general public outside the firewall";
    }
  }
}
